...
The root resource located at https://pbx.sipcentric.com/api/v1/customers lists all customers that the user has access to on the account. 
...
If you do a GET request to http://pbx.sipcentric.com/api/v1/tokengenerator it will return your unique token:

```
{
  "type" : "authtoken",
  "id" : "3cdee810-8cf5-4b91-97f7-174944b7b636",
  "created" : "2013-08-02T14:09:55.222+0000",
  "expires" : "2013-08-02T15:09:55.222+0000"
}
```

So for example you can now use this token to get a call recording using the tokenid parameter in the GET request:

http://pbx.sipcentric.com/api/v1/customers/me/recordings/242348.wav?tokenid=3cdee810-8cf5-4b91-97f7-174944b7b636
