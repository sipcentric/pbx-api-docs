...
| -------------------      | -----------                                                             |  
| **Property**             | **Description**                                                         |  
| type <br> *read only*    | Describes the type of resource. <br> *String*                           |  
...
| Payload Type(s)                | json                                                                   |  
| HTTP Method(s)                 | [GET](#get) <br> [POST](#post) <br> [DELETE](#delete) <br> [PUT](#put) |  
| Representation(s)              | group <br> ivr <br> mailbox <br> phone <br> queue <br> virtual         |  
...
| -------------                        | ---                                                                  |  
| **Property**                         | **Description**                                                      |  
| type <br> *read only*                | Describes the type of resource (`group`). <br> *String*              |  
...
| -------------                | ---                                                                |  
| **Property**                 | **Description**                                                    |  
| type <br> *read only*        | Describes the type of resource (`ivr`). <br> *String*              |  
...
| -------------                | ---                                                                       |  
| **Property**                 | **Description**                                                           |  
| type <br> *read only*        | Describes the type of resource (`mailbox`). <br> *String*                 |  
...
| -------------                     | ---                                                                           |  
| **Property**                      | **Description**                                                               |  
| type <br> *read only*             | Describes the type of resource (`phone`). <br> *String*                       |  
...
| -------------                | ---                                                                      |  
| **Property**                 | **Description**                                                          |  
| type <br> *read only*        | Describes the type of resource (`queue`). <br> *String*                  |  
...
| -------------                     | ---                                                                              |  
| **Property**                      | **Description**                                                                  |  
| type <br> *read only*             | Describes the type of resource (`virtual`). <br> *String*                        |  
