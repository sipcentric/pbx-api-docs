...
| /customers                        |                |               |          |  
| /customers/{id}                   |                |               |          |  
| /customers/{id}/phoneBook         |                |               |          |  
| /customers/{id}/sms               |                |               |          |  
| /customers/{id}/calls             |                |               |          |  
| /customers/{id}/sounds            |                |               |          |  
| /customers/{id}/recordings        |                |               |          |  
| /customers/{id}/timeIntervals     |                |               |          |  
| /customers/{id}/endpoints         |                |               |          |  
| /customers/{id}/phoneNumbers      |                |               |          |  
| /customers/{id}/sounds            |                |               |          |  
| /customers/{id}/outgoingCallerIds |                |               |          |  
| /customers/{id}/creditStatus      |                |               |          |  
| /customers/{id}/callBundles       |                |               |          |  
| /customers/{id}/sip               |                |               |          |  
| /customers/{id}/voicemail         |                |               |          |  
...
| URL                           | Method | Functionality                            |  
| ---                           | ------ | -------------                            |  
| /customers/me/{resource}      | GET    | Retrieve all representations in resource |  
| /customers/me/{resource}/{id} | GET    | Retrieve a specific representations      |  
| /customers/me/{resource}      | POST   | Create a new representations in resource |  
| /customers/me/{resource}/{id} | DELETE | Delete an representations                |  
| /customers/me/{resource}/{id} | PUT    | Update an representations                |  
