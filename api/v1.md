...

{
  ...
  "items":  [
     {
      "type": "timeinterval",
      "uri": "https://pbx.sipcentric.com/api/v1/customers/5/timeintervals/31",
...
{
  "type": "timeinterval",
  "uri": "http://pbx.sipcentric.com/api/v1/customers/5/timeintervals/31",
  "created": "2000-01-01T00:00:00.000+0000",
  "name": "Always",
  "repeat": "WEEKLY",
  "data":  [
...
```
GET http://pbx.sipcentric.com/api/v1/customers/me/endpoints?pageSize=1&page=1
```
...

{
  ...
  "items":  [
     {
      "type": "ivr",
      "uri": "http://pbx.sipcentric.com/api/v1/customers/5/endpoints/101",
  ...
  "nextPage": "http://pbx.sipcentric.com/api/v1/customers/me/endpoints?pageSize=1&page=2"
}
```
...
```
GET http://pbx.sipcentric.com/api/v1/customers/me/phonenumbers?pageSize=1&page=1
```
...

{
  ...
  "items":  [
     {
      "type": "did",
      "uri": "http://pbx.sipcentric.com/api/v1/customers/5/phonenumbers/47",
      "created": "2013-01-23T12:58:41.000+0000",
      "number": "01212854747",
      "identifier": "DID",
      "destination": "http://pbx.sipcentric.com/api/v1/customers/5/endpoints/94",
      "smsEnabled": true
    }
  ],
  "nextPage": "http://pbx.sipcentric.com/api/v1/customers/me/phonenumbers?pageSize=1&page=2"
}
```
...
```
GET http://pbx.sipcentric.com/api/v1/customers/me/outgoingcallerids?pageSize=1&page=1
```
  ...
  "items":  [
     {
      ...
      "uri": "http://pbx.sipcentric.com/api/v1/customers/5/outgoingcallerids/114",
      "created": "2014-02-12T16:36:19.000+0000",
      "number": "Sipcentric",
      "allowCalls": false,
      "allowSms": true
    }
