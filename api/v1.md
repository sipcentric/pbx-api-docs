...
| /customers/{customerId}                   | GET                    | GET                    | GET                    |  
| /customers/{customerId}/phonebook         | GET, POST, PUT, DELETE | GET, POST, PUT, DELETE | GET, POST, PUT, DELETE |  
| /customers/{customerId}/sms               | GET, POST              | GET, POST              | GET, POST              |  
| /customers/{customerId}/calls             | POST                   | GET, POST              | GET, POST              |  
| /customers/{customerId}/sounds            | GET                    | GET                    | GET                    |  
| /customers/{customerId}/recordings        | NONE                   | GET                    | GET                    |  
| /customers/{customerId}/timeintervals     | GET                    | GET                    | GET                    |  
| /customers/{customerId}/endpoints         | GET (own)              | GET                    | GET                    |  
| /customers/{customerId}/phonenumbers      | GET                    | GET                    | GET                    |  
| /customers/{customerId}/outgoingcallerids | GET                    | GET                    | GET                    |  
| /customers/{customerId}/creditstatus      | NONE                   | GET                    | GET                    |  
| /customers/{customerId}/callbundles       | NONE                   | GET                    | GET                    |  
| /customers/{customerId}/sip               | GET (own)              | GET                    | GET                    |  
| /customers/{customerId}/voicemail         | GET (own)              | GET                    | GET                    |  
...
Returns a single customer instance, providing the user is allowed access to that customer. In the case of company admin/extension users, the special ID of `me` can also be used to return the customer account to which the current user belongs.
...
The phonebook sub-resource allows users to read and organize an account's shared phone book entries. Each entry is represented by a `phonebookentry` and can be created, read, updated, and deleted via this resource. When creating or updating a `phonebookentry`, a representation of the new or updated `phonebookentry` must be included with the request.
...
The SMS list resource contains records of every SMS message sent or received on the account. You can also send new SMS messages by POSTing a new `smsmessage` representation to the resource.
...
The calls sub-resource can be used to fetch the call history of an account, as well as to to originate new calls.
