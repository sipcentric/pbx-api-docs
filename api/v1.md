...

{
  ...
  "items":  [
     {
      "type": "smsmessage",
      "uri": "https://pbx.sipcentric.com/api/v1/customers/5/sms/253368",
...

{
  ...
  "items" : [ 
    {
      "type" : "recording",
      "uri" : "https://pbx.sipcentric.com/api/v1/customers/5/recordings/1358371",
      ...
      "endpoint" : "https://pbx.sipcentric.com/api/v1/customers/5/endpoints/2535"
    } 
  ],
...

{
  ...
  "items":  [
     {
      "type": "ivr",
      "uri": "https://pbx.sipcentric.com/api/v1/customers/5/endpoints/101",
...

{
  ...
  "items":  [
     {
      "type": "did",
      "uri": "https://pbx.sipcentric.com/api/v1/customers/5/phonenumbers/47",
      "created": "2013-01-23T12:58:41.000+0000",
      "number": "01212854747",
      "identifier": "DID",
      "destination": "https://pbx.sipcentric.com/api/v1/customers/5/endpoints/94",
      "smsEnabled": true
    }
  ],
  ...
  "items":  [
     {
      ...
      "uri": "https://pbx.sipcentric.com/api/v1/customers/5/outgoingcallerids/114",
  ...
  "items":  [
     {
      ...
      "created": "2010-12-21T08:30:31.000+0000",
      "company": "Sipcentric Ltd.",
      "firstName": "Charles",
      "lastName": "Chance",
      "telephone": "07557400000",
      "email": "charles.chance@sipcentric.com",
      "address1": "16 Holly Lane",
      "address2": "Marston Green",
      "city": "Birmingham",
      "postcode": "B37 7AE"
    }
  ]
...
```
GET https://pbx.sipcentric.com/api/v1/customers/5
```
...
{
  "type": "creditstatus",
  "uri": "https://pbx.sipcentric.com/api/v1/customers/5/creditstatus",
